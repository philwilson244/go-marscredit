...
var (
	...
	abiFlag = &cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the Mars Credit contract ABI json to bind, - for STDIN",
	}
	binFlag = &cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the Mars Credit contract bytecode (generate deploy method)",
	}
...
var app = flags.NewApp("Mars Credit ABI wrapper code generator")
