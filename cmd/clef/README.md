...
This setup allows a DApp to connect to a remote Mars Credit node and send transactions that are locally signed. This can help in situations when a DApp is connected to an untrusted remote Mars Credit node, because a local one is not available, not synchronized with the chain, or is a node that has no built-in (or limited) account management.
  ...
  "params": [
    {
      ...
      "messages": [
        {
          "name": "message",
          "value": "\u0019Mars Credit Signed Message:\n4\u0001\u0002\u0003\u0004",
          "type": "text/plain"
        }
      ],
