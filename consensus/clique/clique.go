...
// ecrecover extracts the Mars Credit account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the Mars Credit address
...
// Mars Credit testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Mars Credit address of the signing key
...
// Author implements consensus.Engine, returning the Mars Credit address recovered
