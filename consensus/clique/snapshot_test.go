...
// mapped from textual names used in the tests below to actual Mars Credit private
...
// address retrieves the Mars Credit address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Mars Credit address
