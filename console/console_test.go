...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Mars Credit service within
	...
	if err != nil {
		t.Fatalf("failed to register Mars Credit protocol: %v", err)
	}
