...
// timestampThreshold is the Mars Credit mainnet genesis timestamp. It is used to
...
// NewID calculates the Mars Credit fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Mars Credit fork ID from an existing chain instance.
