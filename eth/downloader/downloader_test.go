...
func TestCanonicalSynchronisation68Full(t *testing.T)  { testCanonSync(t, eth.MARS68, FullSync) }
func TestCanonicalSynchronisation68Snap(t *testing.T)  { testCanonSync(t, eth.MARS68, SnapSync) }
func TestCanonicalSynchronisation68Light(t *testing.T) { testCanonSync(t, eth.MARS68, LightSync) }
...
func TestThrottling68Full(t *testing.T) { testThrottling(t, eth.MARS68, FullSync) }
func TestThrottling68Snap(t *testing.T) { testThrottling(t, eth.MARS68, SnapSync) }
...
func TestCancel68Full(t *testing.T)  { testCancel(t, eth.MARS68, FullSync) }
func TestCancel68Snap(t *testing.T)  { testCancel(t, eth.MARS68, SnapSync) }
func TestCancel68Light(t *testing.T) { testCancel(t, eth.MARS68, LightSync) }
...
func TestMultiProtoSynchronisation68Full(t *testing.T)  { testMultiProtoSync(t, eth.MARS68, FullSync) }
func TestMultiProtoSynchronisation68Snap(t *testing.T)  { testMultiProtoSync(t, eth.MARS68, SnapSync) }
func TestMultiProtoSynchronisation68Light(t *testing.T) { testMultiProtoSync(t, eth.MARS68, LightSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 68", eth.MARS68, chain.blocks[1:])
...
func TestEmptyShortCircuit68Full(t *testing.T)  { testEmptyShortCircuit(t, eth.MARS68, FullSync) }
func TestEmptyShortCircuit68Snap(t *testing.T)  { testEmptyShortCircuit(t, eth.MARS68, SnapSync) }
func TestEmptyShortCircuit68Light(t *testing.T) { testEmptyShortCircuit(t, eth.MARS68, LightSync) }
...
func TestBeaconSync68Full(t *testing.T) { testBeaconSync(t, eth.MARS68, FullSync) }
func TestBeaconSync68Snap(t *testing.T) { testBeaconSync(t, eth.MARS68, SnapSync) }
...
func TestSyncProgress68Full(t *testing.T)  { testSyncProgress(t, eth.MARS68, FullSync) }
func TestSyncProgress68Snap(t *testing.T)  { testSyncProgress(t, eth.MARS68, SnapSync) }
func TestSyncProgress68Light(t *testing.T) { testSyncProgress(t, eth.MARS68, LightSync) }
