...
// Mars Credit block sync protocol.
//
...
//
// Opposed to the original Mars Credit block synchronization which is trustless (and
...
// not from within (vs. legacy Mars Credit sync).
//
