...
// Package graphql provides a GraphQL interface to Mars Credit node data.
package graphql
...
// Account represents an Mars Credit account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Mars Credit transaction.
...
// Block represents an Mars Credit block.
...
type CallData struct {
	From                 *common.Address // The Mars Credit address the call is from.
	To                   *common.Address // The Mars Credit address the call is to.
