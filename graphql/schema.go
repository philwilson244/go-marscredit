...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Mars Credit address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Mars Credit account at a particular block.
    type Account {
    ...
    # Log is an Mars Credit event log.
    type Log {
    ...
    # Transaction is an Mars Credit transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Mars Credit account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an Mars Credit account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Mars Credit block by number or by hash. If neither is
