...
# Start Geth normally
exec geth --datadir /data --syncmode "full" --http --http.addr 0.0.0.0 --http.port 8545 --http.api personal,eth,net,web3 --networkid 110110 --mine --miner.etherbase=0xYourCoinbaseAddress --bootnodes "$BOOTNODES"